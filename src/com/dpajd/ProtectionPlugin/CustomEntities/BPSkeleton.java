...
public class BPSkeleton extends net.minecraft.server.EntitySkeleton implements BPCustomEntity{
	public BPSkeleton(World world){
		this(world, plugin);
	}
	
	public BPSkeleton(World world, Plugin plugin){
		super(world);
	...
	public void h_(){
		...
		BPHostileEntityMoveEvent e = new BPHostileEntityMoveEvent(skeleton,from,to);
		
		this.world.getServer().getPluginManager().callEvent(e);
		
		if (e.isCancelled() && !skeleton.isDead()){
			return;
		}
